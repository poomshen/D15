 ...
 * @Date : 2016.10.14
 * @Author : 이성준
 * @Desc : 읽지않은 받은 메세지 mypage에 뿌려주는 Service
 */
...
public class TakeNoMessageList_Service implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<Message_DTO> list =  message_DAO.selectNoList(member.getM_no());
		
		request.setAttribute("messagelist", list);
		
		ActionForward forward = new ActionForward();
		
		forward.setPath("MyTakeMessagelist.jsp");
