			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		         	<a class="navbar-brand" href="/TeamProject3_D15/index.jsp"><img style="margin-top:-20px" src="images/logo.gif"></a>
		        </div>
		          ...
		          <ul class="nav navbar-nav navbar-right">
		            ...
		            <li><a href="/TeamProject3_D15/D15/Missing/BoardList.missing"><span>실종신고</span></a></li>
