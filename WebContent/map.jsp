...
<!-- 지도표시 스크립트 -->
	...
	<script>
		var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
			mapOption = {
				center : new daum.maps.LatLng(37.402119, 127.106997), // 지도의 중심좌표
				level : 3// 지도의 확대 레벨
			};
		...
		var map = new daum.maps.Map(mapContainer, mapOption);
		 ...
		 // 마커가 표시될 위치입니다 
		var markerPosition = new daum.maps.LatLng(37.402119, 127.106997);
		...
		var iwContent = '<div style="padding:5px;">KOSTA 129기 1조</div>' // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
			,iwPosition = new daum.maps.LatLng(37.402119, 127.106997); //인포윈도우 표시 위치입니다
