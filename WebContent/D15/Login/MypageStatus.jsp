		...
		<div class="container">
			...
			<ul class="nav nav-tabs">
				<li role="presentation"><a
					href="/TeamProject3_D15/D15/Login/Mypage.login">회원정보</a></li>
				<li role="presentation" class="active"><a
					href="/TeamProject3_D15/D15/Login/MypageStatus.login">분양</a></li>
				<li role="presentation"><a
					href="/TeamProject3_D15/D15/Login/MypageStatus2.login">임시보호</a></li>
			</ul>
		</div>
				...
				<c:forEach var="i" items="${dtolist}">
					<tr>
						...
						<c:choose>
							...
							<c:otherwise>
								<td><button type="button" class="btn btn-success">승인</button>
									${i.pc_argdate}</td>
							</c:otherwise>
						</c:choose>
					</tr>
