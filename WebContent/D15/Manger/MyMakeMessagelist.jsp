...
<script type="text/javascript">
	...
	function outmessage(m_id){
	 ...
	 $.post("/TeamProject3_D15/D15/Login/insertMessage.Message", {"m_id":m_id,"mes_content":$("#mes_content").val()}, function(data, textStatus, req) {
		if(data == 1){
...
<ul class="nav nav-tabs">
			...
			<li class="active"><a href="myMakeMessagelist.Message">보낸 리스트</a></li>
		</ul>
	</div>
